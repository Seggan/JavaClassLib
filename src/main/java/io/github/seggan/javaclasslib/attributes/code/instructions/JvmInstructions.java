...
public final class JvmInstructions {
    ...
    public static final BranchInstruction IF_ACMPEQ = new BranchInstruction(0xa5);
    public static final BranchInstruction IF_ACMPNE = new BranchInstruction(0xa6);

    public static final BranchInstruction IF_ICMPEQ = new BranchInstruction(0x9f);
    public static final BranchInstruction IF_ICMPNE = new BranchInstruction(0xa0);

    public static final BranchInstruction IF_ICMPGE = new BranchInstruction(0xa2);
    public static final BranchInstruction IF_ICMPGT = new BranchInstruction(0xa3);
    public static final BranchInstruction IF_ICMPLE = new BranchInstruction(0xa4);
    public static final BranchInstruction IF_ICMPLT = new BranchInstruction(0xa1);

    public static final BranchInstruction IFEQ = new BranchInstruction(0x99);
    public static final BranchInstruction IFNE = new BranchInstruction(0x9a);

    public static final BranchInstruction IFGE = new BranchInstruction(0x9c);
    public static final BranchInstruction IFGT = new BranchInstruction(0x9d);
    public static final BranchInstruction IFLE = new BranchInstruction(0x9e);
    public static final BranchInstruction IFLT = new BranchInstruction(0x9b);

    public static final BranchInstruction IFNULL = new BranchInstruction(0xc6);
    public static final BranchInstruction IFNONNULL = new BranchInstruction(0xc7);
